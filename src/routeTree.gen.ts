...
const ResultLazyRoute = ResultLazyRouteImport.update({
  id: '/result',
  path: '/result',
...
const DashboardResultLazyRoute = DashboardResultLazyRouteImport.update({
  id: '/Dashboard/Result',
  path: '/Dashboard/Result',
  getParentRoute: () => rootRouteImport,
} as any).lazy(() =>
  import('./routes/Dashboard/Result.lazy').then((d) => d.Route),
)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    '/result': {
      ...
      path: '/result'
      fullPath: '/result'
      preLoaderRoute: typeof ResultLazyRouteImport
    ...
    '/Dashboard/Result': {
      ...
      preLoaderRoute: typeof DashboardResultLazyRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/(errors)/503': {
      id: '/(errors)/503'
